# -*- coding: utf-8 -*-
"""
Created on Tue May 11 20:41:01 2021
...
class Node(object):
    ...
    def genEvent(self):
        ...
        while True :
            ...
            # Generate new events
            #if T<=(z+1)*Duration and T % frequencyEvent == 0:
            ...
            if self.rE > baseE:
                ...
                if T % PT == (self.ti + 4) % PT:
                    ...
                    if True :
                        ...
                        neighbors = [n for n in entities[0].globalG.neighbors(int(self.ID[2:]))]
                            ...
                            if "E-" in self.ID : 
                                ...
                                # if no suitable neighbour founds, data will be dropped
                                    ...
                                    while(len2>0) :
                                        ...
                                        for j in range(len(self.recBuf)):
                                             item = self.recBuf[j]
                                             self.next_hop = neighbors[i] 
                                             entities[self.next_hop].recBuf.append(item)
                                             entities[i].recBuf = entities[i].recBuf[-recBufferCapacity:]
                                             """
                                             if self.next_hop < eG :
